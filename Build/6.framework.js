...
var ASM_CONSTS = {
  2163344: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2163405: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2163469: function() {return Module.webglContextAttributes.powerPreference;},  
 2163527: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2163582: function($0) {performance.now = function() { return $0; };},  
 2163630: function($0) {performance.now = function() { return $0; };},  
 2163678: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _ShowAlert(messagePtr) {
          var message = UTF8ToString(messagePtr);
          alert(message);
      }

  function _ShowPopup(messagePtr) {
          // Convert the C# string reference to a JavaScript string
          var message = UTF8ToString(messagePtr);
          ...
          popupText.textContent = "Link Ready!";
